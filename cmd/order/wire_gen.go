...
var setEventDispatcherDependency = wire.NewSet(events.NewEventDispacther, event.NewOrderCreated, wire.Bind(new(events.EventInterface), new(*event.OrderCreated)), wire.Bind(new(events.EventDispatcherInterface), new(*events.EventDispatcher)))
